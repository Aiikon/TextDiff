...
namespace DiffPlex.DiffBuilder
{
    public class SideBySideDiffBuilder : ISideBySideDiffBuilder
    {
        ...
        public char[] WordSeparaters { get { return _wordSeparators; } set { _wordSeparators = value; } }
        ...
        public SideBySideDiffBuilder(IDiffer differ, char[] wordSeparators) : this(differ)
        {
            ...
            {
                throw new ArgumentException("wordSeparators cannot be null or empty.", "wordSeparators");
            }
        ...
        {
            return BuildDiffModel(oldText, newText, ignoreWhitespace: true);
        }
